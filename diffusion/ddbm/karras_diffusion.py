...
# from piq_clone.piq.perceptual import LPIPS
# from torchmetrics.image.lpip import LearnedPerceptualImagePatchSimilarity as LPIPS
import torchvision.models as models
# from DISTS_pytorch import DISTS
from LTSF_DDBM.utils.dists import DISTS
...
class KarrasDenoiser:
    def __init__(
        ...
        loss_norm="lpips",
        # newly added
        num_timesteps=300, #originally 40
    ):
        ...
        if loss_norm == "lpips":
            ...
            # self.lpips_loss.net.load_state_dict(th.load('/lustre06/project/6033556/zzx/vgg16-397923af.pth'))
            # self.lpips_loss = LPIPS(replace_pooling=True, reduction="none")
            
            self.lpips_loss = DISTS(load_weights=False)
            print('load dists weights')
            # dists_weights_path = "LTSF_DDBM/ckpt/lpips_weights.pt"
            # self.dists_loss.load_state_dict(th.load(dists_weights_path))
