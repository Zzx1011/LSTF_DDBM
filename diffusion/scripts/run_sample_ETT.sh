...
IMG_SIZE=256
NUM_CH=256
python ./scripts/image_sample_ETT_fusion.py --num_head_channels 64 --pred_mode=vp --batch_size 16 --churn_step_ratio 0.5 --steps 40 \
--sampler heun --num_res_blocks 3 --image_size $IMG_SIZE --num_channels $NUM_CH --exp=$EXP ${COND:+ --condition_mode="${COND}"} \
