...
class DISTS(torch.nn.Module):
    def __init__(self, load_weights=True):
        ...
        print("Loading VGG16 weights from local path: /home/zzx/projects/rrg-timsbc/zzx/LTSF_DDBM/ckpt/vgg16_features-amdegroot-88682ab5.pth")
        vgg.load_state_dict(
            torch.load("/home/zzx/projects/rrg-timsbc/zzx/LTSF_DDBM/ckpt/vgg16_features-amdegroot-88682ab5.pth")
        )  # 手动加载本地 VGG16 权重
